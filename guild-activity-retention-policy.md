...
- **Rule:** Members who occupy a guild housing plot and have not logged in for **two (2) months** will be removed from the guild roster. *(Note: This may be updated to removal from the plot only, pending final guild management tool features.)*
